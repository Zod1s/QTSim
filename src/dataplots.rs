...
pub fn plot(path: &str, name: &str, show: bool) -> SolverResult<()> {
    ...
    // let avg_free_min_purity = get_column(&df, "avg_free_min_purity");
    // let avg_ideal_min_purity = get_column(&df, "avg_ideal_min_purity");
    // let avg_ctrl_min_purity = get_column(&df, "avg_ctrl_min_purity");
    // let avg_time_min_purity1 = get_column(&df, "avg_time_min_purity1");
    // let avg_time_min_purity2 = get_column(&df, "avg_time_min_purity2");
    // let avg_time_min_purity3 = get_column(&df, "avg_time_min_purity3");
    // let avg_time_min_purity4 = get_column(&df, "avg_time_min_purity4");
    ...
    time_curve2
        .set_label(&format!("Windowed signal, $k = {}$", 20000))
        .set_marker_every(markerfreq)
        .set_marker_size(5.0)
        .set_marker_style("^")
    ...
    time_curve3
        .set_label(&format!("Windowed signal, $k = {}$", 50000))
        .set_marker_every(markerfreq)
        .set_marker_size(5.0)
        .set_marker_style("v")
    ...
    time_curve4
        .set_label(&format!("Windowed signal, $k = {}$", 100000))
        .set_marker_every(markerfreq)
        .set_marker_size(10.0)
        .set_marker_style("+")
